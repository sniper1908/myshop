...
INSERT INTO `myshop_category` VALUES (1,'测试2',1,1,'test','天天天天','台',1,1,3,'test','filter-attr test');
...
INSERT INTO `myshop_controller_build` VALUES (1,'admin','控制器 - 分类','Category','common\\models\\CategoryModel','modules\\admin\\controllers','modules\\admin\\classes\\BaseController','分类',1514356873);
...
INSERT INTO `myshop_form_build` VALUES (1,'分类','Category','admin','common\\models\\CategoryModel',1514275388);
...
INSERT INTO `myshop_model_build` VALUES (1,'admin','商品分类模型','CategoryModel','common\\models','classes\\ActiveRecord','','',1513908072),(11,'admin','测试模型','TestModel','modules\\build\\models','classes\\ActiveRecord','','',1513908105);
...
INSERT INTO `myshop_view_build` VALUES (1,'商品分类','Category','admin','common\\models\\CategoryModel','cate_name,parent_id,order_num,is_show','',1514427901);
...
-- Dump completed on 2018-01-02 10:23:08
