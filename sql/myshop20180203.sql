...
INSERT INTO `myshop_form_build` VALUES (1,'分类','Category','admin','common\\models\\CategoryModel',1515029422),(2,'商品品牌','Brand','admin','common\\models\\BrandModel',1515376842),(3,'商品类型','GoodsType','admin','common\\models\\GoodsTypeModel',1517630406);
...
INSERT INTO `myshop_goods_type` VALUES (1,'液晶电视',1,'主体,显示,音频');
...
INSERT INTO `myshop_view_build` VALUES (1,'商品分类','Category','admin','common\\models\\CategoryModel','cate_name,parent_id,order_num,is_show','',1514427901),(2,'商品品牌','Brand','admin','common\\models\\BrandModel','','',1515376944),(3,'商品类型','GoodsType','admin','common\\models\\GoodsTypeModel','','',1517630232);
...
-- Dump completed on 2018-02-03 22:14:15
