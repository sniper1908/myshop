										...
										<form class="form-horizontal" id="formMenu" role="form" method="post" action="<?=Url::makeUrl($this->params['module'].'/'.$this->params['controller'].'/'.$this->params['action'].'&id='.$this->params['model']->id)?>">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[controller_name]" id="controllername" value="<?=$model->controller_name?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[controller_class]" id="controllerclass" value="<?=$model->controller_class?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[module_name]" id="modulename" value="<?=$model->module_name?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[model_class]" id="modelclass" value="<?=$model->model_class?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[namespace]" id="namespace" value="<?=$model->namespace?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[base_class]" id="baseclass" value="<?=$model->base_class?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="space-4"></div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="pagetitle">页面标题</label>

												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ControllerBuild[page_title]" id="pagetitle" value="<?=$model->page_title?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
