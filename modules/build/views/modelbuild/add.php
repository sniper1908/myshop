										...
										<form class="form-horizontal" id="formMenu" role="form" method="post" action="<?=Url::makeUrl($this->params['module'].'/'.$this->params['controller'].'/'.$this->params['action'])?>">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ModelBuild[model_name]" id="modelname" placeholder="请输入模型名称" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ModelBuild[model_class]" id="modelclass" placeholder="请输入模型类名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ModelBuild[module_name]" id="modulename" placeholder="请输入模块名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ModelBuild[namespace]" id="namespace" placeholder="请输入命名空间" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ModelBuild[base_class]" id="baseclass" placeholder="请输入完整的基类名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<textarea name="ModelBuild[rules]" id="rules" class="col-xs-10 col-sm-5" rows="15"></textarea>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<textarea name="ModelBuild[labels]" id="labels" class="col-xs-10 col-sm-5" rows="15"></textarea>
													</div>
												</div>
											</div>
