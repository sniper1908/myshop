										...
										<form class="form-horizontal" id="formMenu" role="form" method="post" action="<?=Url::makeUrl($this->params['module'].'/'.$this->params['controller'].'/'.$this->params['action'].'&id='.$this->params['model']->id)?>">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ViewBuild[controller_name]" id="controllername" value="<?=$model->controller_name?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ViewBuild[controller_class]" id="controllerclass" value="<?=$model->controller_class?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ViewBuild[module_name]" id="modulename" value="<?=$model->module_name?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="ViewBuild[model_class]" id="modelclass" value="<?=$model->model_class?>" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<textarea name="ViewBuild[list_attr]" id="rules" class="col-xs-10 col-sm-5" rows="5"><?=$model->list_attr?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<textarea name="ViewBuild[view_attr]" id="rules" class="col-xs-10 col-sm-5" rows="5"><?=$model->view_attr?></textarea>
													</div>
												</div>
											</div>
