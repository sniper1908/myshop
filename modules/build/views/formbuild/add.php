										...
										<form class="form-horizontal" id="formMenu" role="form" method="post" action="<?=Url::makeUrl($this->params['module'].'/'.$this->params['controller'].'/'.$this->params['action'])?>">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="FormBuild[controller_name]" id="controllername" placeholder="请输入控制器名称" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="FormBuild[controller_class]" id="controllerclass" placeholder="请输入控制器类名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="FormBuild[module_name]" id="modulename" placeholder="请输入模块名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="FormBuild[model_class]" id="modelclass" placeholder="请输入模型名" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
