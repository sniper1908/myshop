	...
	<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<ul class="nav ace-nav pull-left">
				<li class="active">
					<a href="<?=Url::makeUrl('index/index')?>">
						<i class="fa fa-home"></i> 首页
					</a>
				</li>
				<?php
					if(!empty($menuHeader)):
						foreach($menuHeader as $k=>$row):
				?>
				<li class="<?=$row['json_data']['bar_color']?>">
					<a data-toggle="tab" class="dropdown-toggle" href="#leftMenu<?=$row['id']?>">
						<i class="<?=$row['json_data']['icon']?>"></i> <?=$row['menu_name'];?>
					</a>
				</li>
				<?php
						endforeach;
				...
				<ul class="nav ace-nav">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							...
							<li>
								<a href="#">
									<img src="<?=STATICS_PUBLIC_DIR?>avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
									<span class="msg-body">
							...
							<li>
								<a href="#">
									<img src="<?=STATICS_PUBLIC_DIR?>avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="#">
									<img src="<?=STATICS_PUBLIC_DIR?>avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?=STATICS_PUBLIC_DIR?>avatars/user.jpg" alt="Jason's Photo" />
							<span class="user-info">
								<small>欢迎光临,</small>
								<?=isset($sessionAdmin['username']) ? $sessionAdmin['username'] : ''?>
							</span>
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							...
							<li>
								<a href="<?=Url::makeUrl('login/logout')?>">
									<i class="icon-off"></i>
									退出
								</a>
							</li>
