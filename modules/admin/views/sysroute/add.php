										...
										<form class="form-horizontal" id="formMenu" role="form" method="post" action="<?=Url::makeUrl($this->params['module'].'/'.$this->params['controller'].'/'.$this->params['action'])?>">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="route[route_module]" id="route-module" placeholder="请输入模块" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="route[route_controller]" id="route-controller" placeholder="请输入控制器" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="route[route_action]" id="route-action" placeholder="请输入方法" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="clearfix">
														<input type="text" name="route[order_num]" class="input-mini" id="spinner3" data-value=0 />
													</div>
												</div>
											</div>
